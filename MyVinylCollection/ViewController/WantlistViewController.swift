...
class WantlistViewController: BaseViewController,  UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UISearchBarDelegate  {


    @IBOutlet weak var searchBar: UISearchBar!
    @IBOutlet weak var wLayoutButtonLabel: UILabel!
    @IBOutlet weak var wSortingButtonLabel: UILabel!
    @IBOutlet weak var wCollectionView: UICollectionView!
    
    var userCollection: [Album]! = []
    var filteredUserCollection: [Album]! = []
    
    var cellSize: CGSize!
    let coverCollectionViewCellIdentifier = "WantlistCollectionViewCell"
    ...
    @IBAction func wLayoutButtonClicked(_ sender: Any) {
        showAlertLayoutTypeBox()
    }
    
    
    @IBAction func wSortButtonClicked(_ sender: Any) {
    ...
    func changingLayout(_ type: Int){
        ...
        case 0:
            layoutChoosen = 0
            wLayoutButtonLabel.text = "List View"
            break
        case 1:
            layoutChoosen = 1
            wLayoutButtonLabel.text = "Small Covers"
        ...
        case 2:
            layoutChoosen = 2
            wLayoutButtonLabel.text = "Medium Covers"
            break
        case 3:
            layoutChoosen = 3
            wLayoutButtonLabel.text = "Large Covers"
            break
        default:
            break
        }
    ...
    func configureCollectionViewLayout(type: Int){
        let layout = wCollectionView.collectionViewLayout
        ...
        let spLayout = wCollectionView.collectionViewLayout as! UICollectionViewFlowLayout
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = self.wCollectionView.dequeueReusableCell(withReuseIdentifier: coverCollectionViewCellIdentifier, for: indexPath) as! WantlistCollectionViewCell
